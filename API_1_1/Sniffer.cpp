...
#define TH_FLAGS        (TH_FIN|TH_SYN|TH_RST|TH_ACK|TH_URG|TH_ECE|TH_CWR)
    ...
    /*******Contructor********/
    Sniffer::Sniffer(bool msn, bool torrent, vector <string> ip_e) {
        act_msn = msn;
        act_torrent = torrent;
        ip_exc = ip_e;
    }
    ...
    print_payload(const u_char *payload, int len, string ip_e, string ip_s, int port_e, int port_s) {
        ...
        RunIA *Corrida = new RunIA(act_msn, act_torrent, ip_exc);
    ...
    void Sniffer::RunSniffing(int argc, char **argv) {
        Sniffer *sniffer = new Sniffer(act_msn, act_torrent, ip_exc);
