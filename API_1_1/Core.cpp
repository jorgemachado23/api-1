...
//
            if (file_in != NULL) {
                ...
                char line[100]; //guarda la linea de la lectura del archivo
                ...
                do {
                    ...
                    if (c != NULL) {
                        ...
                        string ip_address; //guarda la primera palabra de la linea
                ...
                for (int i = 0; i < listIps.size(); i++) {
                    ...
                    string aux(ip_salida);
                        ...
                        if (listIps.at(i) == "172.16.67.2") {
                            
                            listIps.at(i) = aux.c_str();
